...
const files = ['index.html', 'account-action.html', 'account-action.js', 'app.js', 'assistant.js', 'message-cache.js', 'quiz-questions.js', 'games.js', 'agora-calls.js', 'doodle.js', 'firebase-config.js', 'security.js',
